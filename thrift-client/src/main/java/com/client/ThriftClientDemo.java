package com.client;
import com.query.QryResult;
import com.query.TestQry;
...
public static void main(String[] args){
    try {
        Class<?> clientClazz = Class.forName("com.query.TestQry$Client");
        Class<?>[] ifaceArray = clientClazz.getInterfaces();
        Class<?> iface1 = Class.forName("com.query.TestQry$Iface");
