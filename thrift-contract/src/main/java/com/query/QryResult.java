...
@Generated(value = "Autogenerated by Thrift Compiler (0.9.3)", date = "2017-09-19")
public class QryResult implements org.apache.thrift.TBase<QryResult, QryResult._Fields>, java.io.Serializable, Cloneable, Comparable<QryResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new QryResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new QryResultTupleSchemeFactory());
  }
  ...
  private static class QryResultStandardSchemeFactory implements SchemeFactory {
    public QryResultStandardScheme getScheme() {
      return new QryResultStandardScheme();
    }
  }

  private static class QryResultStandardScheme extends StandardScheme<QryResult> {
  ...
  private static class QryResultTupleSchemeFactory implements SchemeFactory {
